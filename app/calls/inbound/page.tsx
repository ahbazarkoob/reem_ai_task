  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Manage and monitor AI-handled inbound calls.</p>
      </div>
      ...
      <Tabs defaultValue="active" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="settings">AI Agent Settings</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="active" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Currently active AI-handled inbound calls</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="queue" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Calls waiting to be handled by AI agents</CardDescription>
            </CardHeader>
            <CardContent>
              <InboundCallQueue />
            </CardContent>
        ...
        <TabsContent value="records" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>History of AI-handled inbound calls</CardDescription>
            </CardHeader>
            <CardContent>
              <InboundCallRecords />
            </CardContent>
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure AI agent behavior for inbound calls</CardDescription>
            </CardHeader>
            <CardContent>
              <AIAgentSettings />
            </CardContent>
