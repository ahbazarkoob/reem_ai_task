...
export default function CampaignDetailPage({
  ...
  const campaign = {
    ...
    description:
      "Quarterly outreach to existing customers to introduce new premium features and gather feedback.",
        ...
        <div className="md:w-2/3 space-y-6">
          ...
          <Tabs defaultValue="performance" className="space-y-4">
            <TabsList>
              <TabsTrigger
                value="performance"
                className="flex items-center gap-1 data-[state=active]:text-primary/80 text-gray-500 data-[state=active]:bg-gray-100"
              >
