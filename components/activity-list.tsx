...
import { Phone, Mail, MessageSquare, Clock, CheckCircle, XCircle, AlertCircle, ChevronRight } from "lucide-react"
...
const activities = [
  {
    ...
    type: "call",
    title: "Outbound Call",
    contact: { name: "John Smith", email: "john@example.com", avatar: "/placeholder.svg?height=40&width=40" },
    campaign: "Q2 Product Demo",
    timestamp: "2023-05-22T14:30:00",
    duration: "4m 12s",
    status: "completed",
    summary: "Discussed new product features, client showed interest in premium plan",
  ...
  },
  {
    ...
    contact: { name: "Sarah Johnson", email: "sarah@example.com", avatar: "/placeholder.svg?height=40&width=40" },
  ...
  },
  {
    ...
    contact: { name: "Michael Brown", email: "michael@example.com", avatar: "/placeholder.svg?height=40&width=40" },
  ...
  },
  {
    ...
    type: "call",
    title: "Inbound Call",
    contact: { name: "Emily Davis", email: "emily@example.com", avatar: "/placeholder.svg?height=40&width=40" },
  ...
  },
  {
    ...
    contact: { name: "Robert Wilson", email: "robert@example.com", avatar: "/placeholder.svg?height=40&width=40" },
  ...
  },
  {
    ...
    contact: { name: "Jennifer Lee", email: "jennifer@example.com", avatar: "/placeholder.svg?height=40&width=40" },
  ...
  },
  {
    ...
    contact: { name: "David Miller", email: "david@example.com", avatar: "/placeholder.svg?height=40&width=40" },
  ...
  },
  {
    ...
    type: "email",
    title: "Welcome Email",
    contact: { name: "Lisa Anderson", email: "lisa@example.com", avatar: "/placeholder.svg?height=40&width=40" },
              ...
              <Card key={activity.id} className="overflow-hidden">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center mb-2">
                        <Avatar className="h-6 w-6 mr-2">
                          <AvatarImage
                            src={activity.contact.avatar || "/placeholder.svg"}
                            alt={activity.contact.name}
                          />
                          <AvatarFallback>{activity.contact.name.substring(0, 2)}</AvatarFallback>
                        </Avatar>
                        <span className="text-sm text-muted-foreground">{activity.contact.name}</span>
                        <span className="mx-2 text-muted-foreground">•</span>
                        <span className="text-sm text-muted-foreground">{activity.campaign}</span>
                        <span className="mx-2 text-muted-foreground">•</span>
                ...
                <CardFooter className="bg-muted/50 px-6 py-3">
                  <div className="flex justify-between items-center w-full">
                    <div className="text-sm text-muted-foreground">Activity ID: {activity.id}</div>
